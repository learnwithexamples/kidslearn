...
step("word_for_level", "wordForLevel", "word_for_level",
  ...
  js=dict(starter="function wordForLevel(level, pool) {\n    return WORD_POOL[0];\n}\n",
    ...
    hints=["Work out which list to use FIRST, then do everything else to that.",
...
step("matching_word", "matchingWord", "matching_word",
  ...
  "<p>One rule beats even that: a word you have typed <strong>in full</strong> wins, wherever it is. Without it, finishing <em>graduate</em> while <em>graduation</em> hangs lower would clear nothing at all — and retyping would not help, because you would land on <em>graduation</em> again. Stuck.</p>"
  "<p><code>lowestWhere</code> is written for you: give it a test, and it hands back the lowest word that passes. Ask it twice.</p>"
  ...
  js=dict(starter="function matchingWord(state, typed) {\n    return null;\n}\n",
    ...
    hints=["lowestWhere(state, test) does the searching — you only choose the test.",
    ...
    tests=[("Typing nothing matches nothing",
           ...
           ("A word typed IN FULL beats a longer one hanging lower",
  ...
  py=dict(starter="def matching_word(state, typed):\n    return None\n",
    ...
    hints=["lowest_where(state, test) does the searching — you only choose the test.",
